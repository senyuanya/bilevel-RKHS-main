...
def Tikh_auto_basis_SGD_nesterov_normalized(A, b, A_ts, b_ts, B, scale_value, rho_val, method):
    ...
    gamma = 0.0
    num_iterations = 5000
    lr0 = 0.005 # 初始基准学习(Laplace: 0.005)
    
    # Nesterov 动量参数
    momentum_factor = 0.95 # Compoundlevy np.sin(x): lr0 = 0.005; momentum_factor = 0.95; num_iterations = 10000;  -0.5*x: lr0 = 0.004; momentum_factor = 0.99; num_iterations = 5000
